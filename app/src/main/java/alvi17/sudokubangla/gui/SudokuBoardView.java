...
//        Log.d(TAG, "heightSize=" + heightSize);
			...
			for (int row = 0; row < 9; row++) {
				for (int col = 0; col < 9; col++) {
					...
					if (value != 0) {
						...
						canvas.drawText(getBanlaNumber(value),
						...
						if (!cell.getNote().isEmpty()) {
							...
							for (Integer number : numbers) {
								...
								canvas.drawText(getBanlaNumber(value), cellLeft + c * noteWidth + 2, cellTop + mNoteTop - noteAscent + r * noteWidth - 1, mCellNotePaint);
							}
						}
					}
	...
	public String getBanlaNumber(int n)
	{
